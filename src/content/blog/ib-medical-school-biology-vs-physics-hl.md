---
title: "IB医学部志望のHL選択｜Biology vs Physics どちらが有利か（日本・海外の入試要件比較）"
slug: "ib-medical-school-biology-vs-physics-hl"
date: "2026-04-19"
description: "医学部志望のIB生向けに、HL科目でBiology と Physics のどちらを選ぶべきかを徹底比較。横浜市立大学・愛知医科大学などの日本の医学部IB入試要件、UCL・Cambridgeなどの英国医学部要件、暗記量と7取得率の実態をIB卒業生講師が解説。"
category: "dp-tips"
ogImage: ""
draft: false
---
...
このようにBio vs Physicsで悩むIB生はとても多いです。結論から言うと、**日本・英国いずれの医学部でも、Physics HLでも医学部出願は可能**です。ただし、大学入学後の学びやすさ、7取得のしやすさを含めて総合的に判断する必要があります。
...
**重要なポイント**：両校とも「物理・化学・生物から2科目」という要件です。つまり**物理＋化学**、**化学＋生物**、**物理＋生物**のいずれの組み合わせでも出願可能です。医学部=生物必須という思い込みは、日本の医学部IB入試に関しては正確ではありません。
...
- HL 7,7,6以上
- **Chemistry必須**
- それに加えて**Biology・Physics・Mathのいずれか1つ**
...
- さらに**Biology・Chemistry・Physics・Mathのいずれか**
...
- Paper 2・3の記述問題では**英語力と生物用語力の両方**が必要（日本語受験でも用語は英語由来）
...
PhysicsをHLで取る場合、**Math AA HLとの併用が学習効率の面で有利**です。AIとPhysicsの組み合わせは計算基盤に課題が出る可能性があります。
...
- どちらも5点以上取れるなら、**医学部志望ならBiology**、**理系研究志望ならPhysics**を基準に決断
...
IBTは、IB卒業生だけで構成されたIB専門の家庭教師サービスです。医学部志望のIB科目選択相談、Biology・Physics・Chemistry HLの科目対策、EEやIAの医療系テーマ選定まで、IB経験者の現役大学生・卒業生講師がマンツーマンで指導します。まずは60分の無料体験からどうぞ。
...
- [IB医学部完全ガイド](/blog/ib-medical-school-guide/)
