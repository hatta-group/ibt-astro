---
title: "IB TOK Essay 2026年5月 6つのプロンプト完全分析｜AOK選定と事例集め"
slug: "ib-tok-essay-may-2026-prompt-analysis"
date: "2026-04-19"
description: "IB TOK Essay 2026年5月セッションの6つの指定タイトル（prescribed titles）を完全分析。必須AOK、事例の選び方、各タイトルの難易度と戦略をIB卒業生講師が解説。1600字上限対応。"
category: "dp-tips"
ogImage: ""
draft: false
---
...
- [TOK Essayの基本仕様（2026年5月セッション）](#tok-essayの基本仕様2026年5月セッション)
- [Title 1：観察という知識ツールの限界](#title-1観察という知識ツールの限界)
- [Title 2：Doubt（疑い）が知識探究の中心か](#title-2doubt疑いが知識探究の中心か)
- [Title 3：知識の伝え方が知識の力を決めるか](#title-3知識の伝え方が知識の力を決めるか)
- [Title 4：Context（文脈）の理解なくして知識は理解できないか](#title-4context文脈の理解なくして知識は理解できないか)
- [Title 5：「すべては数」は芸術と人文にも適用できるか](#title-5すべては数は芸術と人文にも適用できるか)
- [Title 6：Interpretation（解釈）は信頼できる知識生成の道具か](#title-6interpretation解釈は信頼できる知識生成の道具か)
- [タイトル選びの判断フレームワーク](#タイトル選びの判断フレームワーク)
- [事例（real-life examples）の集め方](#事例real-life-examplesの集め方)
- [IBの勉強でお悩みですか？](#ibの勉強でお悩みですか)

## TOK Essayの基本仕様（2026年5月セッション）

- **タイトル数**：6つの指定タイトルから**1つ**を選択
- **字数上限**：**1,600語**（英語、標準フォントサイズ12、ダブルスペース）
- **評価**：TOK全体評価の**3分の2（約67%）**。残り3分の1はTOK Exhibition
- **AOK要件**：すべてのタイトルで**2つのAOK**を扱う必要がある（うち1つが指定されているものもある）
...
Title選択の前に、**各タイトルで使えそうな事例を3つずつ書き出す**テストをします。3つすぐに出ないタイトルは、エッセイ執筆中に事例不足で詰まるリスクが高い。

**ステップ4：対立する視点が作れるか**

TOK Essayで高得点を取るには、自分の主張だけでなく**反対の立場からの批判と再応答**が必要です。「Yes／No」の両極が論じやすいタイトル（1、2、4）は、議論の幅を作りやすい。
...
IBTは、IB卒業生だけで構成されたIB専門の家庭教師サービスです。TOK Essayのタイトル選び、AOK選定、事例集め、アウトライン添削まで、IB経験者の現役大学生・卒業生講師がマンツーマンで指導します。まずは60分の無料体験からどうぞ。
...
- [IB TOK Exhibition プロンプト・オブジェクト選びガイド](/blog/ib-tok-exhibition-prompt-object-selection/)
