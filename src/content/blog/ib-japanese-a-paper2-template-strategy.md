...
- [Paper 2の基本構造（2026年5月〜の新仕様）](#paper-2の基本構造2026年5月の新仕様)
- [なぜ「型」は必要か](#なぜ型は必要か)
- [なぜ先生は「型はリスキー」と言うのか](#なぜ先生は型はリスキーと言うのか)
- [複数テンプレ戦略：2〜3個の型を用意する](#複数テンプレ戦略23個の型を用意する)
- [型の中身：比較エッセイの7段落構成テンプレート](#型の中身比較エッセイの7段落構成テンプレート)
- [新Criterion B2「比較分析」で落とさない書き方](#新criterion-b2比較分析で落とさない書き方)
- [作品選びのルール：IOとHL Essayで使った作品はNG](#作品選びのルールioとhl-essayで使った作品はng)
- [設問選びの時間配分](#設問選びの時間配分)
